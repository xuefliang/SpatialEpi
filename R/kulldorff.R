...
#' data(pennLC_sf)
#' # Disable s2 spherical geometry for centroid calculation
#' sf::sf_use_s2(FALSE)
#'
#' ## Get unique counties (pennLC_sf has multiple rows per county due to strata)
#' counties <- unique(pennLC_sf$county)
#' n_counties <- length(counties)
#'
#' ## Process geographical information and convert to grid
#' # Get one geometry per county
